...
class con_barang extends CI_Controller {
    ...
    function index()
    {
		...
		$this->template->load('template2','barang/lihat_data',$data);
    ...
    function post()
    {
        if(isset($_POST['submit'])){
			...
			$this->template->load('template2','barang/form_input',$data);
        }
    }
    ...
    function edit()
    {
        if(isset($_POST['submit'])){
			...
			$this->template->load('template2','barang/form_edit',$data);
        }
    }
